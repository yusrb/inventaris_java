...
public class Pengeluaran extends javax.swing.JFrame {
    ...
    public Pengeluaran(String username, String level) {
        initComponents();
        
        javax.swing.table.JTableHeader header = tblTampilPengeluaran.getTableHeader();
    ...
    public void Fetch() {
        try {
            pst = conn.prepareStatement("SELECT id, deskripsi, nominal, tanggal FROM pengeluaran_operasional");
            rslt = pst.executeQuery();

            String[] columnNames = { "ID", "Deskripsi", "Nominal", "Tanggal" };
            ...
            while (rslt.next()) {
                ...
                row.add(rslt.getBigDecimal("nominal"));
                row.add(rslt.getDate("tanggal"));
                model.addRow(row);
            }

            tblTampilPengeluaran.setModel(model);
            TableRowSorter<TableModel> sorter = new TableRowSorter<>(model);
            tblTampilPengeluaran.setRowSorter(sorter);

            DefaultTableCellRenderer leftRenderer = new DefaultTableCellRenderer();
            leftRenderer.setHorizontalAlignment(SwingConstants.LEFT);

            for (int i = 0; i < tblTampilPengeluaran.getColumnCount(); i++) {
                tblTampilPengeluaran.getColumnModel().getColumn(i).setCellRenderer(leftRenderer);
            }
    ...
    private void initComponents() {
        ...
        tblTampilPengeluaran = new javax.swing.JTable();
    ...
    tblTampilPengeluaran.setModel(new javax.swing.table.DefaultTableModel(
        new Object [][] {
            {null, null, null, null},
            {null, null, null, null},
            {null, null, null, null},
    ...
    jScrollPane1.setViewportView(tblTampilPengeluaran);

    jLabel3.setFont(new java.awt.Font("Palatino Linotype", 1, 18)); // NOI18N
    jLabel3.setText("Pengeluaran List");
                ...
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(jScrollPane1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 1485, Short.MAX_VALUE)))
                    .addGap(24, 24, 24))))
    );
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        try {
            int pilihBaris = tblTampilPengeluaran.getSelectedRow();

            if (pilihBaris == -1) {
                JOptionPane.showMessageDialog(this, "Data Pengeluaran Tidak Ditemukan\nPilih Data Dulu!!!", "Data Tidak Ditemukan", JOptionPane.WARNING_MESSAGE);
                return;
            }

            int pengeluaranID = (int) tblTampilPengeluaran.getValueAt(pilihBaris, 0);
            String deskripsi = (String) tblTampilPengeluaran.getValueAt(pilihBaris, 1);

            int pilihKonfirmasi = JOptionPane.showConfirmDialog(this, "Yakin Ingin Menghapus \"" + deskripsi + "\"?", "Konfirmasi Hapus", JOptionPane.YES_NO_OPTION);

            if (pilihKonfirmasi == JOptionPane.YES_OPTION) {
                pst = conn.prepareStatement("DELETE FROM pengeluaran_operasional WHERE id = ?");
                pst.setInt(1, pengeluaranID);

                int k = pst.executeUpdate();

                if (k == 1) {
                    JOptionPane.showMessageDialog(this, "Pengeluaran \"" + deskripsi + "\" Berhasil Dihapus!!!", "Hapus Berhasil", JOptionPane.INFORMATION_MESSAGE);
                    Fetch();
                } else {
                    JOptionPane.showMessageDialog(this, "Pengeluaran \"" + deskripsi + "\" Gagal Dihapus!!!", "Hapus Gagal", JOptionPane.WARNING_MESSAGE);
                }
            }
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        PengeluaranForm pengeluaran_form = new PengeluaranForm(this, usernameForPage, levelForPage);
        pengeluaran_form.setVisible(true);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (pilihBaris == -1) {
            JOptionPane.showMessageDialog(this, "Pengeluaran Tidak Ditemukan\nPilih Data Pengeluaran Dulu!!!", "Pengeluaran Tidak Ditemukan", JOptionPane.WARNING_MESSAGE);
            return;
        }

        int pengeluaranID = (int) tblTampilPengeluaran.getValueAt(pilihBaris, 0);
        String deskripsiLama = (String) tblTampilPengeluaran.getValueAt(pilihBaris, 1);
        String nominalLama = String.valueOf(tblTampilPengeluaran.getValueAt(pilihBaris, 2));

        PengeluaranForm pengeluaran_form = new PengeluaranForm(
            this, 
            usernameForPage, 
            levelForPage, 
            pengeluaranID, 
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        try {
            String sql = "SELECT id, deskripsi, nominal, tanggal FROM pengeluaran_operasional WHERE deskripsi LIKE ?";

            pst = conn.prepareStatement(sql);
            pst.setString(1, "%" + keyword + "%");
            rslt = pst.executeQuery();

            DefaultTableModel df = (DefaultTableModel) tblTampilPengeluaran.getModel();
            df.setRowCount(0);
            ...
            while (rslt.next()) {
                ...
                v2.add(rslt.getBigDecimal("nominal"));
    ...
    private void btnBrandsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBrandsActionPerformed
        ...
        Pengeluaran brands_page = new Pengeluaran(usernameForPage, levelForPage);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pengeluaran("Username", "").setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tblTampilPengeluaran;
