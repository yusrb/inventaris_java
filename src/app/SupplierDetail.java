...
public class SupplierDetail extends javax.swing.JFrame {
    ...
    public void Fetch() {
        try {
            ...
            String[] columnNames = { "ID", "Tanggal Masuk", "Jumlah", "Total Harga", "Status" };
            ...
            DefaultTableModel model = new DefaultTableModel(columnNames, 0) {
                ...
                public Class<?> getColumnClass(int columnIndex) {
                    switch (columnIndex) {
                        ...
                        case 1: return java.sql.Date.class;
            ...
            while (rslt.next()) {
                ...
                v2.add(rslt.getInt("total_harga"));
            ...
            tblTampilDetailSupplier.setRowSorter(sorter);

            DefaultTableCellRenderer leftRenderer = new DefaultTableCellRenderer();
            leftRenderer.setHorizontalAlignment(SwingConstants.LEFT);
            for (int i = 0; i < tblTampilDetailSupplier.getColumnCount(); i++) {
                tblTampilDetailSupplier.getColumnModel().getColumn(i).setCellRenderer(leftRenderer);
            }

        } catch (SQLException ex) {
            Logger.getLogger(SupplierDetail.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        tblTampilDetailSupplier = new javax.swing.JTable();
        txtNamaSupplier = new javax.swing.JLabel();
        txtBackToSuppliersList = new javax.swing.JButton();
    ...
    tblTampilDetailSupplier.setModel(new javax.swing.table.DefaultTableModel(
        new Object [][] {
        ...
        new String [] {
            "id", "produk", "total_item", "total_harga", "status", "tanggal"
        }
    ) {
    ...
    jScrollPane1.setViewportView(tblTampilDetailSupplier);

    txtNamaSupplier.setFont(new java.awt.Font("Palatino Linotype", 1, 22)); // NOI18N
    txtNamaSupplier.setText("Supplier Detail : ");

    txtBackToSuppliersList.setBackground(new java.awt.Color(102, 102, 102));
    txtBackToSuppliersList.setForeground(new java.awt.Color(255, 255, 255));
    txtBackToSuppliersList.setText("Kembali Ke Brands List");
    txtBackToSuppliersList.setBorderPainted(false);
    txtBackToSuppliersList.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            txtBackToSuppliersListActionPerformed(evt);
        }
    });
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                .addComponent(txtBackToSuppliersList, javax.swing.GroupLayout.PREFERRED_SIZE, 229, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    layout.setVerticalGroup(
        ...
        .addGroup(layout.createSequentialGroup()
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                .addComponent(txtBackToSuppliersList, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        // TODO add your handling code here:
            ...
            try {
                String sqlSupplier = "SELECT id FROM suppliers WHERE nama_supplier LIKE ?";
                pst = conn.prepareStatement(sqlSupplier);
                ...
                String sqlStock = "SELECT " +
                        ...
                        "stock_in.jumlah, " +
                        "stock_in.deskripsi, " +
                        "stock_in.tanggal_masuk " +
                        "FROM stock_in " +
                        "JOIN products ON stock_in.produk_id = products.id " +
                        "WHERE stock_in.supplier_id = ?";

                pst = conn.prepareStatement(sqlStock);
                pst.setInt(1, supplierID);
                rslt = pst.executeQuery();

                DefaultTableModel df = (DefaultTableModel) tblTampilDetailSupplier.getModel();
                df.setRowCount(0);
                ...
                while (rslt.next()) {
                    ...
                    v2.add(rslt.getDate("tanggal_masuk"));
                    df.addRow(v2);
                }
    ...
    private javax.swing.JTable tblTampilDetailSupplier;
    private javax.swing.JButton txtBackToSuppliersList;
