...
public class CategoryDetail extends javax.swing.JFrame {
    ...
    private final int setCategoryIDFromCategories;
    
    public CategoryDetail(String username, String level, int categoriesId) {
        initComponents();
        
        javax.swing.table.JTableHeader header = tblTampilDetailCategory.getTableHeader();
        ...
        batasiAkses();
        setCategoryIDFromCategories = categoriesId;
    ...
    public void Fetch() {
        try {
            ...
            pst.setInt(1, setCategoryIDFromCategories);

            rslt = pst.executeQuery();

            String[] columnNames = {
                "ID", "Kode Barang", "Nama", "Deskripsi", "Harga", "Stok", "Brand"
            };
            ...
            while (rslt.next()) {
                if (firstRow) {
                    txtNamaKategori.setText("Category Detail : " + rslt.getString("nama_category"));
                    firstRow = false;
                }
            ...
            tblTampilDetailCategory.setModel(model);
            TableRowSorter<TableModel> sorter = new TableRowSorter<>(model);
            tblTampilDetailCategory.setRowSorter(sorter);

            DefaultTableCellRenderer leftRenderer = new DefaultTableCellRenderer();
            leftRenderer.setHorizontalAlignment(SwingConstants.LEFT);

            for (int i = 0; i < tblTampilDetailCategory.getColumnCount(); i++) {
                tblTampilDetailCategory.getColumnModel().getColumn(i).setCellRenderer(leftRenderer);
            }
    ...
    private void initComponents() {
        ...
        tblTampilDetailCategory = new javax.swing.JTable();
        txtNamaKategori = new javax.swing.JLabel();
        backToCategoriesList = new javax.swing.JButton();
        btnSearch = new javax.swing.JButton();
        txtSearch = new javax.swing.JTextField();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("Detail Category Page");
    ...
    tblTampilDetailCategory.setModel(new javax.swing.table.DefaultTableModel(
        new Object [][] {
        ...
        new String [] {
            "id", "kode_barang", "nama", "deskripsi", "harga", "stok", "brand"
        }
    ) {
    ...
    jScrollPane1.setViewportView(tblTampilDetailCategory);

    txtNamaKategori.setFont(new java.awt.Font("Palatino Linotype", 1, 22)); // NOI18N
    txtNamaKategori.setText("Category Detail : ");

    backToCategoriesList.setBackground(new java.awt.Color(102, 102, 102));
    backToCategoriesList.setForeground(new java.awt.Color(255, 255, 255));
    backToCategoriesList.setText("Kembali Ke Categories List");
    backToCategoriesList.setBorderPainted(false);
    backToCategoriesList.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            backToCategoriesListActionPerformed(evt);
        }
    });
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                .addComponent(backToCategoriesList, javax.swing.GroupLayout.PREFERRED_SIZE, 229, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    layout.setVerticalGroup(
        ...
        .addGroup(layout.createSequentialGroup()
            ...
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                .addComponent(backToCategoriesList, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void backToCategoriesListActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backToCategoriesListActionPerformed
        // TODO add your handling code here:
        
        Categories categories_page = new Categories(usernameForPage, levelForPage);
        categories_page.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_backToCategoriesListActionPerformed
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        // TODO add your handling code here:
            ...
            try {
                ...
                DefaultTableModel df = (DefaultTableModel) tblTampilDetailCategory.getModel();
                df.setRowCount(0);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CategoryDetail("Username", "" , 0).setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton backToCategoriesList;
    ...
    private javax.swing.JTable tblTampilDetailCategory;
    private javax.swing.JLabel txtLevelForPage;
    private javax.swing.JLabel txtNamaKategori;
