...
public class Categories extends javax.swing.JFrame {
    ...
    public Categories(String username, String level) {
        initComponents();
        
        javax.swing.table.JTableHeader header = tblTampilCategories.getTableHeader();
    ...
    public void Fetch() {
        try {
            ...
            String[] columnNames = { "ID", "Nama Category" };
            ...
            tblTampilCategories.setModel(model);
            TableRowSorter<TableModel> sorter = new TableRowSorter<>(model);
            tblTampilCategories.setRowSorter(sorter);

            DefaultTableCellRenderer leftRenderer = new DefaultTableCellRenderer();
            leftRenderer.setHorizontalAlignment(SwingConstants.LEFT);

            for (int i = 0; i < tblTampilCategories.getColumnCount(); i++) {
                tblTampilCategories.getColumnModel().getColumn(i).setCellRenderer(leftRenderer);
            }
    ...
    tblTampilCategories.setModel(new javax.swing.table.DefaultTableModel(
        new Object [][] {
            {null, null},
            {null, null},
            {null, null},
    ...
    jScrollPane1.setViewportView(tblTampilCategories);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        int kategoriId = (int) tblTampilCategories.getValueAt(pilihBaris, 0);
        String kategoriNamaKategori = (String) tblTampilCategories.getValueAt(pilihBaris, 1);
        
        int konfirmasiHapus = JOptionPane.showConfirmDialog(this, "Yakin ingin menghapus Kategori " + kategoriNamaKategori + "?", "Konfirmasi Hapus Kategori", JOptionPane.YES_NO_OPTION);
        
       if (konfirmasiHapus == JOptionPane.YES_OPTION)
        {
            try {
                pst = conn.prepareStatement("DELETE FROM categories WHERE id = ?");
                ...
                if (k == 1)
                {
                    JOptionPane.showMessageDialog(this, "Kategori " + kategoriNamaKategori + " Berhasil Dihapus!!!", "Kategori Berhasil Dihapus", JOptionPane.INFORMATION_MESSAGE);
                    Fetch();
                }
                else
                {
                    JOptionPane.showMessageDialog(this, "Kategori " + kategoriNamaKategori + " Gagal Dihapus!!!", "Kategori Gagal Dihapus", JOptionPane.WARNING_MESSAGE);
                }
            } catch (SQLException ex) {
                Logger.getLogger(Categories.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        CategoryForm category_form = new CategoryForm(this, usernameForPage, levelForPage);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (pilihBaris == -1)
        {
            JOptionPane.showMessageDialog(this, "Kategori Tidak Ditemukan\nPilih User Dulu!!!", "Kategoris Tidak Ditemukan", JOptionPane.WARNING_MESSAGE);
            return;
        }
        
        int categoryID = (int) tblTampilCategories.getValueAt(pilihBaris, 0);
        String categoryNamaCategory = (String) tblTampilCategories.getValueAt(pilihBaris, 1);
        
        CategoryForm updateCategoryForm = new CategoryForm(this, usernameForPage, levelForPage ,categoryID, categoryNamaCategory);
    ...
    private void btnDetailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetailActionPerformed
        ...
        CategoryDetail category_detail_page = new CategoryDetail(usernameForPage, levelForPage, categoryID);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Categories("Username", "").setVisible(true);
            }
        });
    }
