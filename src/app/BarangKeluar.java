...
public class BarangKeluar extends javax.swing.JFrame {
    ...
    public void Fetch() {
        try {
            ...
            tblTampilBarangKeluar.setModel(model);

            TableRowSorter<TableModel> sorter = new TableRowSorter<>(model);
            tblTampilBarangKeluar.setRowSorter(sorter);

            DefaultTableCellRenderer leftRenderer = new DefaultTableCellRenderer();
            leftRenderer.setHorizontalAlignment(SwingConstants.LEFT);

            for (int i = 0; i < tblTampilBarangKeluar.getColumnCount(); i++) {
                tblTampilBarangKeluar.getColumnModel().getColumn(i).setCellRenderer(leftRenderer);
            }
    ...
    jLabel3.setText("Barang Keluar List");
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        BarangKeluarForm barang_keluar_form = new BarangKeluarForm(this, usernameForPage, levelForPage);
