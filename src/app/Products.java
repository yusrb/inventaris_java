...
public class Products extends javax.swing.JFrame {
    ...
    public Products(String username, String level) {
        initComponents();
        
        javax.swing.table.JTableHeader header = tblTampilProducts.getTableHeader();
    ...
    public void Fetch() {
        try {
            ...
            String[] columnNames = {
                "ID", "Kode Barang", "Nama", "Deskripsi", "Harga", "Stok", "Kategori", "Brand"
            };
            ...
            tblTampilProducts.setModel(model);
            TableRowSorter<TableModel> sorter = new TableRowSorter<>(model);
            tblTampilProducts.setRowSorter(sorter);
            
            DefaultTableCellRenderer centerRenderer = new DefaultTableCellRenderer();
            centerRenderer.setHorizontalAlignment(SwingConstants.LEFT);

            for (int i = 0; i < tblTampilProducts.getColumnCount(); i++) {
                tblTampilProducts.getColumnModel().getColumn(i).setCellRenderer(centerRenderer);
            }
    ...
    private void initComponents() {
        ...
        jPanel25.setBackground(new java.awt.Color(147, 112, 219));

        jLabel14.setFont(new java.awt.Font("Palatino Linotype", 1, 30)); // NOI18N
    ...
    layout.setVerticalGroup(
        ...
        .addGroup(layout.createSequentialGroup()
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                .addGroup(layout.createSequentialGroup()
                    .addComponent(btnNotifikasi, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(31, 31, 31)
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        ProductsForm products_form_page = new ProductsForm(this, usernameForPage, levelForPage);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        ProductsForm products_form_page = new ProductsForm(this, usernameForPage, levelForPage ,id, kodeBarang ,nama, deskripsi, harga, stok, kategori, brand);
        products_form_page.setVisible(true);
