...
public class Users extends javax.swing.JFrame {
    ...
    public Users(String username, String role) {
        ...
        javax.swing.table.JTableHeader header = tblTampilUsers.getTableHeader();
        ...
        txtRoleForUsername.setText(levelForPage);
    ...
    private void initComponents() {
        ...
        txtRoleForUsername.setFont(new java.awt.Font("Palatino Linotype", 1, 30)); // NOI18N
        txtRoleForUsername.setForeground(new java.awt.Color(255, 255, 255));
        txtRoleForUsername.setText("Adminstrator");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtRoleForUsername))
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        int pilihBaris = tblTampilUsers.getSelectedRow();
        
        if (pilihBaris == -1)
        {
            JOptionPane.showMessageDialog(this, "User Tidak Ditemukan, Pilih User dulu!!!", "User Tidak Ditemukan", JOptionPane.WARNING_MESSAGE);
            return;
        }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        try {
            ...
            int pilihUser = tblTampilUsers.getSelectedRow();
            ...
            String userUsername = (String) tblTampilUsers.getValueAt(pilihUser, 1);
            int userId = (int) tblTampilUsers.getValueAt(pilihUser, 0);
            
            int konfirmasiHapus = JOptionPane.showConfirmDialog(this, "Yakin Ingin Menghapus\nUser Bernama " + userUsername + "?", "Konfirmasi Hapus", JOptionPane.YES_NO_OPTION);
            ...
            if (konfirmasiHapus == JOptionPane.YES_OPTION)
            {
                ...
                if (k == 1)
                {
                    JOptionPane.showMessageDialog(this, "Berhasil Menghapus User!!!", "Hapus User Berhasil", JOptionPane.INFORMATION_MESSAGE);
                    Fetch();
                }
                else
                {
                    JOptionPane.showMessageDialog(this, "Gagal Menghapus User!!!", "Hapus User Gagal", JOptionPane.WARNING_MESSAGE);
                }
            }
         } catch (SQLException ex) {
            Logger.getLogger(Users.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Users("Username", "").setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tblTampilUsers;
