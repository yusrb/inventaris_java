 ...
 * @author yusrb
 */
public class DetailSalesTransactions extends javax.swing.JFrame {
    ...
    public DetailSalesTransactions(String username, String level, int transaksiId) {
        initComponents();
        
        javax.swing.table.JTableHeader header = tblDetailSalesTransactions.getTableHeader();
    ...
    public void Fetch() {
            try {
                pst = conn.prepareStatement(
                    "SELECT kode_barang, nama, jumlah, subtotal FROM transaksi_detail WHERE transaksi_id = ?"
                );
                pst.setInt(1, transaksiId);
                rslt = pst.executeQuery();

                String[] columnNames = {"Kode Barang", "Nama", "Jumlah", "Subtotal"};
                ...
                while (rslt.next()) {
                    ...
                    row.add(rslt.getInt("subtotal"));
                    model.addRow(row);
                }

                tblDetailSalesTransactions.setModel(model);
                TableRowSorter<TableModel> sorter = new TableRowSorter<>(model);
                tblDetailSalesTransactions.setRowSorter(sorter);

                DefaultTableCellRenderer leftRenderer = new DefaultTableCellRenderer();
                leftRenderer.setHorizontalAlignment(SwingConstants.LEFT);

                for (int i = 0; i < tblDetailSalesTransactions.getColumnCount(); i++) {
                    tblDetailSalesTransactions.getColumnModel().getColumn(i).setCellRenderer(leftRenderer);
                }

            } catch (SQLException ex) {
                Logger.getLogger(DetailSalesTransactions.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    private void initComponents() {
        ...
        tblDetailSalesTransactions = new javax.swing.JTable();
        txtNamaBrand = new javax.swing.JLabel();
        txtBackToSalesTransactions = new javax.swing.JButton();
        btnSearch = new javax.swing.JButton();
        txtSearch = new javax.swing.JTextField();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("Detail Sale Transactions Page");
    ...
    tblDetailSalesTransactions.setModel(new javax.swing.table.DefaultTableModel(
        new Object [][] {
        ...
        new String [] {
            "id", "kode_barang", "nama", "deskripsi", "harga", "stok", "category"
        }
    ) {
    ...
    jScrollPane1.setViewportView(tblDetailSalesTransactions);

    txtNamaBrand.setFont(new java.awt.Font("Palatino Linotype", 1, 22)); // NOI18N
    txtNamaBrand.setText("Sale Detail : ");

    txtBackToSalesTransactions.setBackground(new java.awt.Color(102, 102, 102));
    txtBackToSalesTransactions.setForeground(new java.awt.Color(255, 255, 255));
    txtBackToSalesTransactions.setText("Kembali Ke Transaksi List");
    txtBackToSalesTransactions.setBorderPainted(false);
    txtBackToSalesTransactions.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            txtBackToSalesTransactionsActionPerformed(evt);
        }
    });
        ...
        .addGroup(layout.createSequentialGroup()
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                    .addGap(24, 24, 24)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(txtNamaBrand)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                .addComponent(txtBackToSalesTransactions, javax.swing.GroupLayout.PREFERRED_SIZE, 229, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(txtSearch, javax.swing.GroupLayout.PREFERRED_SIZE, 193, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, 0)
                                .addComponent(btnSearch))
                            .addComponent(jScrollPane1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 1486, Short.MAX_VALUE)))
                    .addGap(24, 24, 24))))
    );
    layout.setVerticalGroup(
        ...
        .addGroup(layout.createSequentialGroup()
            ...
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                .addComponent(txtBackToSalesTransactions, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void txtBackToSalesTransactionsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtBackToSalesTransactionsActionPerformed
        // TODO add your handling code here:
        ...
        this.dispose();
    }//GEN-LAST:event_txtBackToSalesTransactionsActionPerformed
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        try {
            String sql = "SELECT dt.id, dt.id_transaksi, dt.kode_barang, p.nama, p.deskripsi, dt.harga, dt.jumlah, dt.subtotal " +
                         "FROM detail_transaksi dt " +
                         "JOIN products p ON dt.kode_barang = p.kode_barang " +
                         "WHERE dt.id_transaksi = ? AND (p.nama LIKE ? OR dt.kode_barang LIKE ?)";
            ...
            DefaultTableModel model = (DefaultTableModel) tblDetailSalesTransactions.getModel();
            model.setRowCount(0);
            ...
            while (rslt.next()) {
                ...
                v2.add(rslt.getDouble("subtotal"));
                model.addRow(v2);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetailSalesTransactions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DetailSalesTransactions("Username", "", 0).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tblDetailSalesTransactions;
    private javax.swing.JButton txtBackToSalesTransactions;
    private javax.swing.JLabel txtNamaBrand;
