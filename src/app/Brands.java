...
public class Brands extends javax.swing.JFrame {
    ...
    public Brands(String username, String level) {
        initComponents();
        
        javax.swing.table.JTableHeader header = tblTampilBrands.getTableHeader();
    ...
    public void Fetch() {
        try {
            ...
            String[] columnNames = { "ID", "Nama Brand" };
            ...
            while (rslt.next()) {
                ...
                row.add(rslt.getString("nama_brand"));
                model.addRow(row);
            }

            tblTampilBrands.setModel(model);
            TableRowSorter<TableModel> sorter = new TableRowSorter<>(model);
            tblTampilBrands.setRowSorter(sorter);

            DefaultTableCellRenderer leftRenderer = new DefaultTableCellRenderer();
            leftRenderer.setHorizontalAlignment(SwingConstants.LEFT);

            for (int i = 0; i < tblTampilBrands.getColumnCount(); i++) {
                tblTampilBrands.getColumnModel().getColumn(i).setCellRenderer(leftRenderer);
            }
    ...
    private void initComponents() {
        ...
        tblTampilBrands = new javax.swing.JTable();
    ...
    tblTampilBrands.setModel(new javax.swing.table.DefaultTableModel(
        new Object [][] {
            {null, null},
            {null, null},
            {null, null},
    ...
    jScrollPane1.setViewportView(tblTampilBrands);

    jLabel3.setFont(new java.awt.Font("Palatino Linotype", 1, 18)); // NOI18N
    jLabel3.setText("Brand List");
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        try {
            ...
            int pilihBaris = tblTampilBrands.getSelectedRow();
            
            if (pilihBaris == -1)
            {
                JOptionPane.showMessageDialog(this, "Brand Tidak Ditemukan\nPilih User Dulu!!!", "Brand Tidak Ditemukan", JOptionPane.WARNING_MESSAGE);
                return;
            }
            
            int brandID = (int) tblTampilBrands.getValueAt(pilihBaris, 0);
            String brandNamaBrand =(String) tblTampilBrands.getValueAt(pilihBaris, 1);
            
            int pilihKonfirmasi = JOptionPane.showConfirmDialog(this, "Yakin Ingin Menghapus " + brandNamaBrand + "?", "Konfirmasi Hapus", JOptionPane.YES_NO_OPTION);
            
            if (pilihKonfirmasi == JOptionPane.YES_OPTION)
            {
                pst = conn.prepareStatement("DELETE FROM brands WHERE id = ?");
                ...
                if (k == 1)
                {
                    JOptionPane.showMessageDialog(this, "Brand " + brandNamaBrand + " Berhasil Dihapus!!!", "Hapus Brand Berhasil", JOptionPane.INFORMATION_MESSAGE);
                    Fetch();
                }
                else
                {
                    JOptionPane.showMessageDialog(this, "Brand " + brandNamaBrand + " Gagal Dihapus!!!", "Hapus Brand Gagal", JOptionPane.WARNING_MESSAGE);
                }
            }
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        BrandsForm brands_form = new BrandsForm(this, usernameForPage, levelForPage);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        BrandsForm updateBrandsForm = new BrandsForm(this, usernameForPage, levelForPage, brandID, brandNamaBrand);
        updateBrandsForm.setVisible(true);
    ...
    private void btnDetailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetailActionPerformed
        ...
        if (pilihBaris == -1)
        {
            JOptionPane.showMessageDialog(this, "Brand Tidak Ditemukan\nPilih Brand Dulu", "Brand Tidak Ditemukan", JOptionPane.WARNING_MESSAGE);
        }
        
        int brandId = (int) tblTampilBrands.getValueAt(pilihBaris, 0);
        
        BrandDetail brand_detail_page = new BrandDetail(usernameForPage, levelForPage, brandId);
        brand_detail_page.setVisible(true);
        this.dispose();
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        try {
            String sql = "SELECT * FROM brands WHERE nama_brand LIKE ?";

            pst = conn.prepareStatement(sql);
            pst.setString(1, "%" + keyword + "%");
            rslt = pst.executeQuery();

            DefaultTableModel df = (DefaultTableModel) tblTampilBrands.getModel();
            df.setRowCount(0);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Brands("Username", "").setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tblTampilBrands;
